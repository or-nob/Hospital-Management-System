 ...
 * @author user
 */
public class Patient_Medicine_Update extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String Update = request.getParameter("Updated_Medicine");
        ...
        if(Update.equals("Update")){
            db.update_medicine(gmid, mname, gname, mprice, quantity);
        }
    }
