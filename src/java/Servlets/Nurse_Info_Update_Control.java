 ...
 * @author user
 */
public class Nurse_Info_Update_Control extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(Ok.equals("Update")){
            ...
            String institute = request.getParameter("ninstitute");
            String sex = request.getParameter("nsex");
            ...
            db.update_nurse_info(eid, name, phone, email, sex, newdob, newdot, address, degree, institute);
            HttpSession session = request.getSession();
            session.setAttribute("NurseList", db.NurseList());
            //make a success page
        }
    }
